...
<?php
	...
	if(isset($_POST['id'])){
		...
		$id=implode(",",$_POST['id']);
		$sql= "DELETE FROM `danhmuc` WHERE id in ($id)";
    // echo $sql;exit;
          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class=" panel-title"><a class="btn btn-danger align-right" href="http://localhost/BTL/admin/danhmuc/add.php">Thêm mới<i class="fa fa-plus"></i></a></h3>
    ...
    <!-- Advanced Tables -->
        <div class="panel panel-default">
			...
			foreach($categories as $category){?>
                        ...
                        <td><?= $i?></td>
						<td> <?php if($category['parent'] > 0) echo "--"; echo "--".$category['ten'];?></td> 
